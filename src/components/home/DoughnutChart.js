...
const ChartLabel = (props) => {
  ...
  return <li className='chart-legend-item'>

            <span className='chart-legend-color' style={{
...
class DoughnutChart extends Component {
    ...
    render() {
        return (
            <Col className='chart-wrapper' sm='12' md={{size: 10, offset: 1}}
                        lg={{size: 5, offset: 0}}>
                        ...
                        <ul className='chart-legend'>

                            {
                                map(this.state.currentPeriodData.labels, (item, index) => {
                                    return <ChartLabel
                                        color={
                                            this.state.currentPeriodData.datasets[0].backgroundColor[index]}
